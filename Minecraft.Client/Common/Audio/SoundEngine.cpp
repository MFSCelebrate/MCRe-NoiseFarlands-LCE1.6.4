...
char SoundEngine::m_szMusicPath[] = { "DurangoMedia\\Music\\" }; // str1k3r - this might not work or might cant test
char SoundEngine::m_szRedistName[] = { "redist64" };
/*#elif defined _XBOX // Just a approxamation, this is either supposed to be here or not
...
char SoundEngine::m_szMusicPath[] = { "OrbisMedia\\Music\\" }; // str1k3r - this might not work or might cant test
char SoundEngine::m_szRedistName[] = { "redist64" };
#elif defined __PSVITA__
char SoundEngine::m_szSoundPath[] = { "PSVita\\Sound\\" };
char SoundEngine::m_szMusicPath[] = { "PSVitaMedia\\Music\\" }; // str1k3r - this might not work or might cant test
char SoundEngine::m_szRedistName[] = { "redist" };
#elif defined __PS3__
//extern const char* getPS3HomePath();
char SoundEngine::m_szSoundPath[] = { "PS3\\Sound\\" };
char SoundEngine::m_szMusicPath[] = { "PS3Media\\music\\" }; // str1k3r - this might not work or might cant test
char SoundEngine::m_szRedistName[] = { "redist" };
