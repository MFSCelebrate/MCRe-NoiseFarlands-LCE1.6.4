...
# Make sure the Settings directory exists, only supported on Windows
...
# Make sure the Stats directory exists, only supported on Windows
function(add_stats_target TARGET_NAME)
  add_custom_target(EnsureStats_${TARGET_NAME} ALL
    COMMAND ${CMAKE_COMMAND}
      -E make_directory "$<TARGET_FILE_DIR:${TARGET_NAME}>/Windows64/Stats"
    COMMENT "Ensuring Stats directory exists..."
    VERBATIM
  )
  add_dependencies(${TARGET_NAME} EnsureStats_${TARGET_NAME})
  set_property(TARGET EnsureStats_${TARGET_NAME} PROPERTY FOLDER "Build")
endfunction()
